...
print(listado.split()[0:2])#arroja los objetos que se encuentran "hasta" la posicion solicitada dentro de la lista creada con SPLIT ['cafe,', 'te,'] "no incluida" la segunda posicion[:02]