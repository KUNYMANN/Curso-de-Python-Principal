...
precio1=190.5 #habitacion CVM
precio2=150.5 #habitacion SVM
...
dias=int(input("Indique la cantidad de días que va a alojarse en el hotel: "))
cuartos_vm_txt=input("Desea un cuarto con vista al mar? (Si/No): ").strip().lower()

#Chequeo si se ingreso un "si" o "no", sino error
if cuartos_vm_txt=="si" or cuartos_vm_txt=="no":
   
   if cuartos_vm_txt=="si":
      costo_total=dias*precio1
   else:
      costo_total=dias*precio2
   ...
   print(f"Habitacion con vista al mar: {cuartos_vm_txt}")
   print(     '\n"GRACIAS POR ALOJARSE EN NUESTRO HOTEL"')

else:
   print("Error con la asignacion de dormitorio, intentelo de nuevo")
